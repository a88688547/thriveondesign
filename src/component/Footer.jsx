const Footer = () => {
  return (
    <div className="w-full py-[25px] md:py-[50px] bg-black text-white">
      <div className="max-w-[1000px] mx-auto">
        <div>
          <div className="flex flex-col md:flex-row justify-center items-center break-all gap-4 mb-[34px]">
            <div className="w-full md:w-1/2 text-center">
              <div className="text-lg">Thrivecommerce@gmail.com</div>
              {/* <div className="text-[10px]">3F., No. 695, Xue Qin Rd., New Taipei City, Taiwan</div> */}
            </div>
          </div>
          <div className="flex gap-2 justify-center items-center mb-[20px] md:mb-[40px]">
            <div className=" rounded-full bg-white overflow-hidden w-[32px] h-[32px]">
